...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO bookings (firstName, lastName,email, checkin, checkout, roomType,paymentMethod) VALUES ('$firstName','$lastName' ,'$clientEmail', '$checkinDate', '$checkoutDate', '$roomType' , ' $paymentMethod')";
